VERIFUSR TITLE 'VERIFUSR - PROGRAM TO CHECK RACF PROFILE'
***********************************************************************
***********************************************************************
***                                                                 ***
***      MODULE - VERIFUSR                                          ***
...
***                                                                 ***
***      The program checks access to a spcific RACF class.         ***
***                                                                 ***
...
***      ----------------          --------------                   ***
***      VERIFUSR (RENT)           LINKLIB concatenation            ***
***       AMODE(31) RMODE(ANY)                                      ***
***                                                                 ***
***********************************************************************
***********************************************************************
...
* static data
*
RACCLASS DC    CL4'APPL'                      RACF CLASS
ENTITYX  DC    AL2(0,L'RACPROF)
RACPROF  DC    CL7'XXXXXXX'                  RACF PROFILE
RACWORK  DS    CL512
SAVEAREA DS    18F
*
*
